...
class RuntimeShellTool(
    ...
    suspend fun killByRunId(runId: String): String {
        ...
        return prefixRunId(
            runtime = router.runtimeById(com.highsockscapital.sunshine.data.LocalRuntimeId.Termux),
            rawResult = router.runtimeById(com.highsockscapital.sunshine.data.LocalRuntimeId.Termux)
