...
import com.highsockscapital.sunshine.data.AppUpdateRelease
...
data class SunshineUiState(
    ...
    val modelCatalogInfo: Map<String, com.highsockscapital.sunshine.data.ModelCatalogInfo> = emptyMap(),
