...
private const val ForegroundChannelId = "sunshine_background_runs"
private const val CompletionChannelId = "sunshine_completed_runs"
const val ForegroundNotificationId = 1001

class SunshineNotificationController(
    ...
    fun ensureChannels() {
        ...
        val foregroundChannel = NotificationChannel(
            ...
            description = "Shows active Sunshine sessions running in the background."
            setShowBadge(false)
        }
        val completionChannel = NotificationChannel(
            ...
            description = "Alerts you when a background Sunshine session finishes."
        }
    ...
    fun buildForegroundNotification(
        ...
        val title = if (activeSessions.size == 1) {
            "Sunshine is running 1 task"
        } else {
            "Sunshine is running ${activeSessions.size} tasks"
        }
    ...
    fun notifyCompletion(
        ...
        val title = if (failed) {
            "Sunshine task finished with an issue"
        } else {
            "Sunshine task finished"
        }
