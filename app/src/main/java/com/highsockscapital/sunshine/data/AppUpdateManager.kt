...
private const val GithubLatestReleaseUrl =
    "https://api.github.com/repos/highsockscapital/Sunshine/releases/latest"
private const val GithubLatestNightlyRunUrl =
    "https://api.github.com/repos/highsockscapital/Sunshine/actions/workflows/build-nightly-apk.yml/runs?branch=main&status=success&per_page=1"
private const val NightlyArtifactDownloadUrl =
    "https://nightly.link/highsockscapital/Sunshine/workflows/build-nightly-apk.yml/main/Sunshine-nightly.zip"
    ...
    suspend fun fetchLatestNightly(): AppUpdateRelease {
        ...
        client.newCall(request).execute().use { response ->
            ...
            return AppUpdateRelease(
                ...
                apkFileName = "Sunshine-nightly-$shortSha.apk",
