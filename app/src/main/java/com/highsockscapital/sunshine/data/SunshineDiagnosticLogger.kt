...
class SunshineDiagnosticLogger private constructor(
    ...
    fun installUncaughtExceptionHandler() {
        ...
        if (previous is SunshineUncaughtExceptionHandler) return
        Thread.setDefaultUncaughtExceptionHandler(
            SunshineUncaughtExceptionHandler(
                logger = this,
                previous = previous,
            )
        )
    ...
    companion object {
        val NoOp = SunshineDiagnosticLogger(null)
    }
}
...
private class SunshineUncaughtExceptionHandler(
    private val logger: SunshineDiagnosticLogger,
