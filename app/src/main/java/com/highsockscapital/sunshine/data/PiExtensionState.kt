...
private val Context.piExtensionStateDataStore by preferencesDataStore(
    name = "sunshine_pi_extension_state",
)
...
internal val DefaultDisabledPreinstalledExtensionIds: Set<String> = setOf(
    "import:sunshine:/root/.sunshine/extensions/pi-web-access",
    "import:sunshine:/root/.sunshine/extensions/pi-mcp-adapter",
    "import:sunshine:/root/.sunshine/extensions/pi-subagents",
)
