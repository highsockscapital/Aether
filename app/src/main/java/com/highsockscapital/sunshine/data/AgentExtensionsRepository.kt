...
private val Context.agentExtensionsDataStore by preferencesDataStore(name = "sunshine_agent_extensions")
...
class AgentExtensionsRepository(
    ...
    val extensionState: Flow<AgentExtensionsState> = context.agentExtensionsDataStore.data.map { preferences ->
        AgentExtensionsState(
            ...
            // MCP is no longer an Sunshine persistence/runtime feature. Keep the
