...
import com.highsockscapital.sunshine.runtime.LocalRuntime
...
private const val McpLogTag = "SunshineMcp"
...
private class StdIoMcpTransport(
    ...
    private fun brokerRootPath(): String =
        "${runtime.homeDirectory}/.sunshine/mcp-brokers/$serverId"
...
internal fun appendMcpStdioRequestForwarder(builder: StringBuilder) {
    ...
    builder.appendLine("      if [ \"\${SUNSHINE_MCP_STDIO_FRAMING:-newline}\" = 'content-length' ]; then")
