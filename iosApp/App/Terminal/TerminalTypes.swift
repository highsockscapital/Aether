...
struct TerminalPalette {
    ...
    static func defaultForeground(darkTheme: Bool) -> UIColor {
        darkTheme
            ? UIColor(red: 204/255, green: 204/255, blue: 204/255, alpha: 1)
            : .black
    }

    static func defaultBackground(darkTheme: Bool) -> UIColor {
    ...
    static func resolve(
        ...
        case .default:
            return isForeground
                ? defaultForeground(darkTheme: darkTheme)
                : defaultBackground(darkTheme: darkTheme)
