...
**Model Context Protocol (MCP) adapter extension for Pi agent. Connect MCP servers over Stdio, Streamable HTTP, SSE, or Unix sockets without burning your context window.**
