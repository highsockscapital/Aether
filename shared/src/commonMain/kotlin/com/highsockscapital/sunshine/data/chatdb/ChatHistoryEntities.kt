...
@Entity(
    ...
    primaryKeys = ["chatSessionId", "sunshineMessageId", "piEntryId"],
    foreignKeys = [
        ForeignKey(
            entity = ChatMessageEntity::class,
            parentColumns = ["sessionId", "id"],
            childColumns = ["chatSessionId", "sunshineMessageId"],
            onDelete = ForeignKey.CASCADE,
        ),
    ],
    indices = [Index(value = ["chatSessionId", "piEntryId"]), Index(value = ["chatSessionId", "sunshineMessageId"])],
)
data class ChatAgentMessageRefEntity(
    val chatSessionId: String,
    val sunshineMessageId: String,
