...
interface ChatHistoryDao {
    ...
    @Query("SELECT * FROM chat_agent_message_refs WHERE chatSessionId = :sessionId ORDER BY sunshineMessageId, ordinal")
    suspend fun getAgentMessageRefs(sessionId: String): List<ChatAgentMessageRefEntity>

    @Query("SELECT * FROM chat_agent_message_refs WHERE chatSessionId = :sessionId AND sunshineMessageId = :messageId ORDER BY ordinal")
