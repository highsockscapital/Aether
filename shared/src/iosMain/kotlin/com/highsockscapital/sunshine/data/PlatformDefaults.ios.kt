...
actual fun platformDefaultSystemPrompt(): String =
    "You are Sunshine, a local-first agent that can call tools and complete tasks on-device. Use available tools instead of guessing local state."

actual fun platformDefaultLlmUserAgent(): String = "Sunshine/1.0 (iOS)"
